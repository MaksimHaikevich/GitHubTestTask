...
import {numFormatter} from "../../services/numFormater";
  ...
  <div className="profile-info">
    ...
    <div className="info">
      ...
      <div className="social-info">
        <div className="social-info-count">
          ...
          <div className="info-count">
            {`${numFormatter(props.followersCount)} followers`}
          </div>
        </div>
        <div className="social-info-count">
          ...
          <div className="info-count">
            {`${numFormatter(props.followingCount)} following`}
          </div>
        </div>
      </div>
    </div>
